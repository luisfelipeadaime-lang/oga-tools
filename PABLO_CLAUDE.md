...
| `dashboard.html` / v3 | Live (→ dashboard-v3.html) | tools.oga.earth/tools/dashboard-v3.html | Sales Command Center — ClearSky team access. Deal pipeline + weekly call targets. Thin shell over /api/revenue/* endpoints. Thread classification not wired. Absorption candidate into pablo.html. |
